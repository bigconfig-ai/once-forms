...
- `src/io/github/amiorin/once_forms/core.clj` — http-kit server on port 8080. Accepts JSON POSTs, emails the payload via Resend SMTP, and responds with an echo. CORS is open to `*`.
